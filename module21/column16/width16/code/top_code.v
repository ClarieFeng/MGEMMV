...
module DataReOrganize#(
    ...
    parameter  a_tile_column_size = 16
    )(
    // interface to system
    input wire clk,                         
    input wire rst_n,                   
    ...
    reg [data_width * 12 - 1 : 0] row11_delay;
    reg [data_width * 13 - 1 : 0] row12_delay;
    reg [data_width * 14 - 1 : 0] row13_delay;
    reg [data_width * 15 - 1 : 0] row14_delay;
    reg [data_width * 16 - 1 : 0] row15_delay;
...
// Always block for reset and functionality
    always @(negedge rst_n or posedge clk) begin
        if (~rst_n) begin
            ...
            row11_delay [data_width - 1 : 0] <= din [data_width * 12 - 1 : data_width * 11];
            row12_delay [data_width - 1 : 0] <= din [data_width * 13 - 1 : data_width * 12];
            row13_delay [data_width - 1 : 0] <= din [data_width * 14 - 1 : data_width * 13];
            row14_delay [data_width - 1 : 0] <= din [data_width * 15 - 1 : data_width * 14];
            row15_delay [data_width - 1 : 0] <= din [data_width * 16 - 1 : data_width * 15];
            ...
            row11_delay [data_width * 12 - 1 : data_width] <= row10_delay [data_width * 11 - 1 : 0];
            row12_delay [data_width * 13 - 1 : data_width] <= row11_delay [data_width * 12 - 1 : 0];
            row13_delay [data_width * 14 - 1 : data_width] <= row12_delay [data_width * 13 - 1 : 0];
            row14_delay [data_width * 15 - 1 : data_width] <= row13_delay [data_width * 14 - 1 : 0];
            row15_delay [data_width * 16 - 1 : data_width] <= row14_delay [data_width * 15 - 1 : 0];
            ...
            dout [data_width * 12 - 1 : data_width * 11] <= row11_delay [data_width * 12 - 1 : data_width * 11];
            dout [data_width * 13 - 1 : data_width * 12] <= row12_delay [data_width * 13 - 1 : data_width * 12];
            dout [data_width * 14 - 1 : data_width * 13] <= row13_delay [data_width * 14 - 1 : data_width * 13];
            dout [data_width * 15 - 1 : data_width * 14] <= row14_delay [data_width * 15 - 1 : data_width * 14];
            dout [data_width * 16 - 1 : data_width * 15] <= row15_delay [data_width * 16 - 1 : data_width * 15];
        end
    end
endmodule
